...
public class TowerDefensePathFinder extends Pathfinder {
    ...
    // Temp
    public int get(int health, int team, boolean solid, boolean liquid, boolean legSolid, boolean nearLiquid, boolean nearGround, boolean nearSolid, boolean nearLegSolid, boolean deep, boolean damages, boolean allDeep, boolean nearDeep, boolean teamPassable) {
